...
**By using a boolean value you can see that comparing the outputs from the two methodes (using the function aggregate and using the pipe method) gives the value TRUE beacouse they are the same.**
```{r}
#c
...
**two tables presenting the top ten counties with new corona cases and deaths .**
...
```{r}
#c
cor_eco <- cor_eco[which(cor_eco$Date == "2020-03-31"),]
