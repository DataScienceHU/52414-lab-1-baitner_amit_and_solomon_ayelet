...
**Q1, we loaded the data from John's Hopkins Corona Database for cases, deaths and recovered number of people. Then we change the data class for the column Date. To check the class we print the class of column Date and you can see it is prints "date". **
```{r}
#a
