...
**n this section, we created new columns for death and corona cases that show the day-to-day change in quantities so that the rate of change can also be checked. We used a loop that subtracts two consecutive days and creates a column of changes**
```{r}
#a
