...
**two tables presenting the top ten counties with new corona cases and corona's deaths.**
...
plot(italy_cases$Date, italy_cases$Diff,type="o", xlab = "Date", ylab = "Value - corona cases and deaths", main= "Italy- daily corona deaths and new cases by date ",pch = 8, col= "red", las=1, ylim=c(0, 7000))
