...
plot(flt_march$pop65, flt_march$nor_cases, xlab = "% population over age 65", ylab = "Corona cases", main= "Corona cases and deaths vs % population over age 65", pch = c(8), col=ifelse(flt_march$pop65 >24,'red','blue'), las=2)
