...
country<- unique(eco_data$country)
library(tidyr)
feature_1 <- unique(eco_data$feature)
eco <- data.frame(country, )

eco %>% select(1:6)
colnames(eco) <- c("country", "GDP","pop65","pop_city_ratio", "pop_total_columns")
...
corona_and_eco <- semi_join(eco, corona)###
